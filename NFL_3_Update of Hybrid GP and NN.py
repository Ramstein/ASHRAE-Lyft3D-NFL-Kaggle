...
with open(r'C:\Users\Ramstein\Desktop\kaggle_2\train.pkl', 'rb') as f:
    train = pickle.load(f)
print('laoded the train.pkl file.')
...
# X.drop(['Season', 'GameWeather', 'Orientation', 'Dir','WindSpeed', "DefensePersonnel","OffensePersonnel", 'Yards', 'GameId','PlayId'], axis=1, inplace=True)
# X.drop(['Orientation', 'Dir','WindSpeed', 'GameId','PlayId'], axis=1, inplace=True)
...
from keras.models import Sequential
from keras.layers import Dense, Dropout, Flatten, Concatenate, Input, Embedding, GlobalAveragePooling1D, Activation
...
model.compile(optimizer=keras.optimizers.Adam(lr=0.002, decay=1e-4),
...
# %%time
model.fit(X_train, y_train, callbacks=[metric],
          verbose=0,
          epochs=500,
          batch_size=2048,
          validation_data=(X_val, y_val))
loss = model.history.history["val_CRPS"][-1]

# models.append(model)
# losses.append(loss)


model.save('NFl_3_01.pth')
print('NFL_3.pth saved.')
...
class GP:
    ...
    def GP_class_1(self, data):
        return (0.250000 * np.tanh((((((((
            ...
            (4.88989353179931641)))) - ((13.92175483703613281)))) / 2.0)) - (data[:, 6]))) +
                ...
                ((((((data[:, 7]) * 2.0)) - (((((data[:, 0]) - (data[:, 14]))) - (data[:, 7]))))) - (data[:, 0]))))) + (
                                                     data[:, 0]))))) +
    ...
    def GP_class_3(self, data):
        return (0.250000 * np.tanh(((((
                ...
                ((((10.56953334808349609)) + ((((4.48959350585937500)) + (np.tanh(((((3.0)) + ((9.0))))))))) / 2.0)))) +
    ...
    def GP_class_4(self, data):
        return (0.250000 * np.tanh((((12.98819637298583984)) / 2.0)) +
                ...
                ((((((8.66014671325683594)) + ((4.18107128143310547))) / 2.0)) * ((8.97841739654541016))))) / 2.0)) +
        ...
        return (0.250000 * np.tanh((10.27210903167724609)) +
                ...
                0.250000 * np.tanh(((((((((
                            (((((data[:, 9]) - (((data[:, 0]) - (data[:, 0]))))) - (((data[:, 0]) / 2.0)))) / 2.0)) - (
                                         ((data[:, 21]) - (data[:, 7]))))) + (data[:, 21])) / 2.0)) - (data[:, 0]))) +
    ...
    def GP_class_10(self, data):
        ...
        (((((data[:, 14]) + (data[:, 20])) / 2.0)) + (data[:, 0])))) / 2.0)) + (data[:, 14])) / 2.0)) +
                ...
                0.250000 * np.tanh(((
                                    (((((data[:, 14]) + (np.tanh((((data[:, 6]) / 2.0))))) / 2.0)) + (data[:, 14]))) + (
    ...
    def GP_class_13(self, data):
        return (0.250000 * np.tanh(((((np.tanh((np.tanh((data[:, 2]))))) - ((10.0)))) - (np.tanh(
            (((((data[:, 7]) - ((((((6.0)) - ((4.87243366241455078)))) - ((9.0)))))) - ((14.80352973937988281)))))))) +
                ...
                (((((data[:, 9]) + (((data[:, 5]) + (data[:, 14]))))) + (data[:, 9])) / 2.0))))))) / 2.0)))) * 2.0)) + (
                                    data[:, 14]))) +
    ...
    def GP_class_14(self, data):
        ...
        (((7.0)) + ((4.74105215072631836)))))) - (((((7.0)) + (((data[:, 5]) * 2.0))) / 2.0)))) - ((9.0)))) +
                ...
                (((((data[:, 2]) / 2.0)) + (data[:, 9])) / 2.0))) / 2.0)) + (np.tanh((data[:, 10])))) / 2.0)) + (
                                           data[:, 9]))) + (data[:, 9])) / 2.0)) + (data[:, 21]))) + (data[:, 3]))) +
                0.250000 * np.tanh(
                ...
                0.250000 * np.tanh((((
                                     ((data[:, 2]) + ((((((data[:, 13]) + (data[:, 14]))) + (data[:, 13])) / 2.0)))) + (
                                         np.tanh((data[:, 2])))) / 2.0)))
    ...
    def GP_class_15(self, data):
        ...
        ((((np.tanh(((13.93556308746337891)))) - (data[:, 18]))) + ((13.93556308746337891)))))) +
                ...
                ((data[:, 15]) + (data[:, 14]))))) + (((data[:, 14]) / 2.0)))))) + (data[:, 14]))) + (data[:, 14]))) +
    ...
    def GP_class_16(self, data):
        return (0.250000 * np.tanh((((((
            ...
            (((9.0)) - (((((((data[:, 13]) / 2.0)) / 2.0)) + ((((-1.0 * ((((data[:, 4]) / 2.0))))) * 2.0)))))))) - (
                ...
                (((((((((data[:, 9]) + (data[:, 9]))) - ((3.0)))) + (data[:, 7]))) + (data[:, 9])) / 2.0))))) / 2.0)) +
    ...
    def GP_class_17(self, data):
        return (0.250000 * np.tanh((((
                    (data[:, 14]) - ((((data[:, 5]) + (((((14.43326377868652344)) + ((6.0))) / 2.0))) / 2.0)))) - (
                                    ((((((10.0)) + ((14.84462165832519531))) / 2.0)) - ((((7.0)) + (data[:, 13]))))))) +
                0.250000 * np.tanh((((((((((data[:, 14]) + (
                ((((((((data[:, 11]) - ((9.71331787109375000)))) / 2.0)) + ((9.0)))) - ((3.0))))) / 2.0)) - (
                                        (10.0)))) - ((((10.0)) + ((((9.0)) - ((((((10.0)) - ((9.0)))) / 2.0)))))))) - (
                                    (10.0)))) +
                ...
                ((((np.tanh((((((((8.0)) * (data[:, 8]))) + (data[:, 11])) / 2.0)))) / 2.0)) - ((8.0))))) / 2.0)) - (
                                        data[:, 20]))) - ((((8.0)) * 2.0)))) + ((8.0)))) +
                0.250000 * np.tanh(((data[:, 8]) + (
                ...
                ((((((data[:, 21]) + (data[:, 9])) / 2.0)) + (data[:, 6])) / 2.0))) / 2.0)) + (
                                                                                       data[:, 17])) / 2.0)))) + (
                                                                  ((data[:, 15]) / 2.0))) / 2.0))))) / 2.0)) * 2.0)) +
                0.250000 * np.tanh(((data[:, 1]) + (
                ((((data[:, 3]) + (data[:, 15]))) + (np.tanh(((((data[:, 20]) + (((data[:, 1]) * 2.0))) / 2.0)))))))))
...
for (test_df, sample_prediction_df) in iter_test:
    basetable = preprocesss(test_df)
    basetable = create_features(basetable, deploy=True)
    # basetable.drop(
    #     ['Season', 'GameWeather', 'Orientation', 'Dir', 'WindSpeed', "DefensePersonnel", "OffensePersonnel", 'GameId',
    #      'PlayId'], axis=1, inplace=True)
