...
def offense_personnel(x):
    o_personal = {'0 RB, 0 TE, 5 WR': 66, '0 RB, 1 TE, 4 WR': 6600, '0 RB, 2 TE, 3 WR': 352,
                  ...
                  '1 RB, 1 TE, 3 WR': 106, '1 RB, 2 TE, 1 WR,1 DB': 308, '1 RB, 2 TE, 1 WR,1 DL': 12298,
                  ...
                  '1 RB, 3 TE, 1 WR': 18679, '1 RB, 4 TE, 0 WR': 0, '2 QB, 1 RB, 0 TE, 3 WR': 638,
...
def preprocess(train):
    ...
    dropped_col = ['NflId', 'DisplayName', 'GameClock', 'TimeHandoff', 'TimeSnap',
                   'PlayerBirthDate']
